...
List<Team> defineDungeonBowlTeams()
{
    ...
    Position firelinos = new Position("Linemen", 16);
    ...
    Position shadowLinos = new Position("Linemen", 16);
    //not that kind
    Position shadowRunners = new Position("Runners", 4);
    Position shadowBlitzers = new Position("Blitzers", 2);
    Position shadowThrowers = new Position("Throwers", 2);
    Position shadowSpecial = new Position("Special", 2);
    ...
    Position lightLinos = new Position("Linemen", 16);
    Position lightRunners = new Position("Runners", 4);
    Position lightBlitzers = new Position("Blitzers", 2);
    Position lightThrowers = new Position("Throwers", 2);
    ...
    Position linos = new Position("Linemen", 16);
    ...
    Position blockers = new Position("Blockers", 6);
    ...
    Position deathLinos = new Position("Linemen", 16);
    ...
    Position deathRunners = new Position("Runners", 4);
    ...
    Position deathBlitzers = new Position("Blitzers", 4);
    ...
    Position deathBlockers = new Position("Blockers", 4);
    ...
    Position deathBigGuys = new Position("Big Guys", 2);
    ...
    Position lifeLinemen = new Position("Linemen", 16);
    Position lifeRunners = new Position("Runners", 4);
    Position lifeBlitzers = new Position("Blitzers", 2);
    Position lifeThrowers = new Position("Throwers", 2);
    Position lifeBlockers = new Position("Blockers", 4);
    Position lifeSpecial = new Position("Special", 4);
    Position lifeBigGuys = new Position("Big Guys", 2);
    ...
    Position beastsLinos = new Position("Linemen", 16);
    Position beastsRunners = new Position("Runners", 2);
    Position beastsBlitzers = new Position("Blitzers", 4);
    Position beastsBlockers = new Position("Blockers", 4);
    Position beastsBigGuys = new Position("Big Guys", 3);
    Position beastsSpecial = new Position("Special", 2);
    ...
    Position heavensLino = new Position("Linemen", 16);
    Position heavensBlitzers = new Position("Blitzers", 4);
    Position heavensThrowers = new Position("Throwers", 4);
    Position heavensBlockers = new Position("Blockers", 6);
    Position heavensSpecial = new Position("Special", 2);
...
List<Team> defineBloodBowlTeams()
{
    ...
    Position humanCatchers = new Position("Catchers", 4);
    ...
    Position humanBlitzers = new Position("Blitzers", 4);
    ...
    Position owDB = new Position("Dwarf Blockers", 2);
    ...
    Position owH = new Position("Halfling", 2);
    ...
    Position orcBli = new Position("Blitzers", 4);
